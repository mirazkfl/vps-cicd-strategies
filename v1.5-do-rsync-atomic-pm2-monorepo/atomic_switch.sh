#!/bin/bash
# Atomic switch script for monorepo apps
# This script is generated automatically by setup_monorepo.sh
# It's placed in /home/deploy/apps/{app-name}/scripts/atomic_switch.sh
